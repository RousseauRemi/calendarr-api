...
public class GetAllBooksUseCase : IGetAllBooksUseCase
{
    ...
    public GetAllBooksUseCase( IArrExternalServiceRepository arrExternalServiceRepository, IGetApisService getApisService)
    {
    ...
    public async Task<List<ArrApiResult>> Get(DateTime start, DateTime end, CancellationToken ct)
    {
        ...
        var apis = await _getApisService.Get(ApiTypeEnum.Readarr, ct);
